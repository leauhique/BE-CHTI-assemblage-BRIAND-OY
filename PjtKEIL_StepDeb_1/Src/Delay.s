...
Delay_100ms proc
		...
		str r1,[r0]  ;store TimeVal dans le regitre de r0
		
BoucleTempo	
		ldr r1,[r0]; r1 = VarTime				
						
		subs r1,#1 ; Vartime = Vartime - #1
		str  r1,[r0] ; ecrit VarTime dans le registre de r0
		bne	 BoucleTempo ; Boucle si VarTime != 0?
			
		bx lr  ; retour de la fonction
		endp
